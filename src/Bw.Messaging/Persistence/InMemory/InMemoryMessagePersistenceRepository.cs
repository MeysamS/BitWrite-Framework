...
namespace Bw.Messaging.Persistence.InMemory;
...
public class InMemoryMessagePersistenceRepository : IMessagePersistenceRepository
{
    ...
    public Task<IReadOnlyList<StoreMessage>> GetByFilterAsync(Expression<Func<StoreMessage, bool>> predicate, CancellationToken cancellationToken = default)
    {
