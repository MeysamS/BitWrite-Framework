...
{
    public static IServiceCollection Replace<TService, TImplemention>(
        this IServiceCollection services,
        ServiceLifetime lifetime)
    {
        return services.Replace(new ServiceDescriptor(typeof(TService), typeof(TImplemention)));
    }
    ...
    public static IServiceCollection ReplaceScoped<TService>(
        this IServiceCollection services,
        Func<IServiceProvider, TService> implementionFactory)
        where TService : class
    {
        return services.Replace(ServiceDescriptor.Scoped(implementionFactory));
    }
