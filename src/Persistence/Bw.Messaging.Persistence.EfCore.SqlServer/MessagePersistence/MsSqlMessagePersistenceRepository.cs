...
public class MsSqlMessagePersistenceRepository : IMessagePersistenceRepository
{
    private readonly MessagePersistenceDbContext _persistenceDbContext;
    private readonly ILogger<MsSqlMessagePersistenceRepository> _logger;

    public MsSqlMessagePersistenceRepository(
        MessagePersistenceDbContext persistenceDbContext,
        ILogger<MsSqlMessagePersistenceRepository> logger
    )
    {
